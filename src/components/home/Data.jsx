...
function Data() {
  return (
    <div className='home_data'>
      <h1 className="home_title">Taimoor Ali
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className="home_description">I'm a proficient MERN stack developer with expertise in building dynamic web applications using MongoDB, Express.js, React, and Node.js.</p>
